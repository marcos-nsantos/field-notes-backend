...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Marcos Santos",
            "url": "https://github.com/marcos-nsantos"
        },
        "license": {
            "name": "MIT"
        },
    ...
    "paths": {
        ...
        "/auth/refresh": {
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Token expired/revoked/invalid",
                        "schema": {
                            "$ref": "#/definitions/httputil.ErrorResponse"
                        }
                    }
        ...
        "/sync": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Sync data with client notes",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SyncRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.SyncResponse"
                        }
                    },
                    "400": {
                        "description": "Device not found or validation error",
                        "schema": {
                            "$ref": "#/definitions/httputil.ErrorResponse"
                        }
                    },
        ...
        "/upload/{note_id}": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid file or note ID",
                        "schema": {
                            "$ref": "#/definitions/httputil.ErrorResponse"
                        }
                    },
        ...
        "request.SyncRequest": {
            ...
            "properties": {
                ...
                "notes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.SyncNote"
                    }
                },
                "sync_cursor": {
                    "type": "string"
